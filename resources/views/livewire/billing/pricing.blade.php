...
// Pricing page (renders the Volt component via Blade wrapper or directly if you prefer Volt routing)
Route::view('/pricing', 'billing.pricing')->middleware(['auth']);

// Billing index (post-subscription landing)
...
<?php
	/**
	 * BLADE WRAPPER: resources/views/billing/pricing.blade.php
	 */
?>
<?php /*
@extends('layouts.app')
...
<?php
	/**
	 * NOTES:
	 * - This component uses Stripe Setup Intents + the Payment Element to collect a reusable payment method
	 *   and then calls the Livewire action to create the subscription for the TENANT.
	 * - If you show prices dynamically from Stripe, you can fetch amounts via the Dashboard API
	 *   but most teams hardcode numbers in the UI and keep the `price_...` IDs in env.
	 * - Ensure you include Stripe.js in your layout head:
