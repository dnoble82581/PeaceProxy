...
<div class="flex">
						...
						<ul
							...
							<li>
								...
								<a
									...
									<span
											aria-hidden="true"
											class="ml-auto w-9 min-w-max rounded-full bg-gray-900 px-2.5 py-0.5 text-center text-xs/5 font-medium whitespace-nowrap text-white ring-1 ring-gray-700 ring-inset">5</span>
								</a>
							</li>
							<li>
								<a
							...
							<li>
								<a
									...
									<span
											aria-hidden="true"
											class="ml-auto w-9 min-w-max rounded-full bg-gray-900 px-2.5 py-0.5 text-center text-xs/5 font-medium whitespace-nowrap text-white ring-1 ring-gray-700 ring-inset">12</span>
								</a>
							</li>
							<li>
								<a
									...
									<span
											aria-hidden="true"
											class="ml-auto w-9 min-w-max rounded-full bg-gray-900 px-2.5 py-0.5 text-center text-xs/5 font-medium whitespace-nowrap text-white ring-1 ring-gray-700 ring-inset">20+</span>
								</a>
							</li>
							<li>
								<a
	...
	<div class="w-full">
		<div class="bg-gray-100 dark:bg-gray-700 h-16 flex items-center justify-between px-10 ">
			<div>
				<p class="text-sm dark:text-white">{{ authUser()->tenant->agency_name }}</p>
			</div>
				...
				<x-dropdown>
					<x-slot:action>
						<img
								...
								src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
								alt="User Avatar"
								class="inline-block size-10 rounded-full hover:cursor-pointer" />
					</x-slot:action>
					<x-dropdown.items
							class=""
							icon="cog"
