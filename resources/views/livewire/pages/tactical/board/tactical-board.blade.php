...
<div
            ...
            <div class="border-b border-gray-200 dark:border-dark-400">
                <nav aria-label="Tabs" class="-mb-px flex space-x-8">
                    ...
                    <button
                            @click="tab = 'teams'"
                            class="group inline-flex gap-1 items-center border-b-2 px-1 py-2 text-sm font-medium hover:cursor-pointer text-gray-700 hover:text-gray-900 hover:border-gray-300 dark:text-dark-300 dark:hover:border-dark-400 dark:hover:text-dark-400"
                            :class="{'border-b-primary-500 text-primary-600 dark:text-primary-400': tab === 'teams', 'border-transparent': tab !== 'teams'}">
    ...
    <div class="mt-4 space-y-2" x-show="tab === 'maps'">
    ...
    <div class="mt-4" x-show="tab === 'teams'">
        <div class="p-4 text-gray-600 dark:text-dark-200">
            <p class="text-sm">Team assignments, status, and coordination tools will appear here.</p>
            <!-- Placeholder content; plug in your tactical team management component when ready -->
        </div>
    </div>
</div>
