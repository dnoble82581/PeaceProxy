...
class RfiReplyPostedEvent implements ShouldBroadcastNow
{
    ...
    public function __construct(public RequestForInformationReply $reply)
    {
    }

    public function broadcastOn(): PrivateChannel
    {
        return new PrivateChannel("tenants.{$this->reply->tenant_id}.rfi.{$this->reply->request_for_information_id}");
    }
